...
def make_FSS_loss(mask_size, want_discretization=0): # choose any mask size for calculating densities
    ...
    def my_FSS_loss(y_true, y_pred):
        ...
        pool1 = tf.keras.layers.AveragePooling2D(pool_size=(mask_size, mask_size), strides=(1, 1), padding='valid')
